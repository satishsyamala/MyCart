...
function Login(props) {
    ...
    return (<div>
        ...
        <Dialog className="user_card" header="Sign Up" className="register_dl" visible={visible} onHide={(e) => onHidde()} >
            <div >
        ...
        <Dialog className="user_card" header="Change Password" className="register_dl" visible={passChange} onHide={(e) => onHidde()} >
