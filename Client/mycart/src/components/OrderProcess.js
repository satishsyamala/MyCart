            ...
            {orderInfo && <div className="order_view"  >
                ...
                <div ref={componentRef}>
                    ...
                    <div className="row" style={{ paddingLeft: "20px", width: "100%" }} >
                        <div style={{ width: "50%" }} >  <Divider type="dashed"><b>Summary</b></Divider>
                            <div className="card" style={{ paddingLeft: "20px", height: "80%" }}>
                    ...
                    <div className="order-table">
                        ...
                        <DataTable className="order-table" value={orderInfo.items} items="data" var1="data">
                            <Column field="cat_name" header="Category"></Column>
