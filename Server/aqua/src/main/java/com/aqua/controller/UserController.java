...
import com.aqua.service.intf.UserServiceIntf;
...
public class UserController {
	...
	public JSONArray getStocks(@RequestParam("id") int id) {
		  HttpHeaders headers = new HttpHeaders();
	      headers.setAccept(Arrays.asList(MediaType.APPLICATION_JSON));
	      HttpEntity <String> entity = new HttpEntity<String>(headers);
	      return restTemplate.exchange("http://localhost:8090/wms/stock/stocks", HttpMethod.GET, entity, JSONArray.class).getBody();
	}
